SoundClone is my training version of SoundCloud, built to sharpen my frontend skills while integrating with a Django backend. The project includes all the core features of a music streaming platform:
